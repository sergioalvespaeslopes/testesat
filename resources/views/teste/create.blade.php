<!-- resources/views/teste/create.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body class="container mt-5">
    ...
    <h1 class="mb-4">Criar Novo Registro</h1>

    @if(session('success'))
        <div class="alert alert-success">{{ session('success') }}</div>
    @endif

    <form method="POST" action="{{ route('teste.store') }}" class="mb-4">
        @csrf
        <div class="mb-3">
        ...
        <!-- Adicione os demais campos de endereço (número, cidade, UF, etc.) aqui -->
